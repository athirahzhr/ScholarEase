...
const programs = [
  {
    title: 'Khazanah Watan Scholarship – Equity Pathway Programme',
    provider: 'Yayasan Khazanah',
    url: 'https://www.yayasankhazanah.com.my/scholarship-programmes/khazanah-watan-scholarship-%e2%80%93-equity-pathway-programme'
  }
];
...
(async () => {
  ...
  console.log('🔍 Scraping: Khazanah Equity');
...
for (const tab of tabs) {
  ...
  detectDeadline(rawText);
    ...
    results.push({
      ...
      rules,
      source: 'scraped',
      source_website: 'khazanah_equity',
...
`);
  ...
  console.log(
    '🎉 Khazanah equity scraping completed'
  );
