...
const programs = [
  {
    ...
    url: 'https://www.yayasankhazanah.com.my/scholarship-programmes/wakalah-paynet-yayasan-khazanah-scholarship-programme'
  },
];
...
(async () => {
  ...
  console.log('🔍 Scraping: Khazanah Paynet');
