...
const programs = [
  {
    ...
    url: 'https://penajaan.jpa.gov.my/info-penajaan/latihan-sebelum-perkhidmatan/program-pelajar/program-penajaan-nasional-ppn.html'
  }
];

(async () => {

  console.log('🚀 Scraping JPA : PPN Foundation');
...
console.log(
  ...
  const outputPath =
    path.join(outputDir, 'jpa.ppn.json');
...
`);
  ...
  console.log('🎉 JPA: PPN scraping completed');
