...
const programs = [
  {
    ...
    provider: 'PETRONAS',
    url: 'https://www.petronas.com/bm/careers/students-graduates'
  }
];

(async () => {

  console.log('🚀 Scraping PETRONAS Foundation');
...
console.log(
  ...
  const outputPath =
    path.join(outputDir, 'petronas.json');
...
`);
  ...
  console.log('🎉 PETRONAS scraping completed');
