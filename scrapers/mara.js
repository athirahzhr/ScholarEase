...
const programs = [
  {
    title: 'MARA Pembiayaan Pelajaran Peringkat Persediaan',
    provider: 'MARA',
    url: 'https://www.mara.gov.my/bm/pendidikan/pembiayaan-pelajaran/peringkat-persediaan/'
  }
];

(async () => {

  console.log('🚀 Scraping MARA');
