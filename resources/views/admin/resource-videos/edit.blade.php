...
@section('title', 'Edit Resource Video')
...
<style>
    ...
    .btn-warning-custom {
        background: linear-gradient(115deg, #f59e0b, #d97706);
        border: none;
        padding: 0.65rem 1.5rem;
        border-radius: 40px;
        font-weight: 600;
    ...
    .btn-warning-custom:hover {
        ...
        background: linear-gradient(115deg, #d97706, #b45309);
        color: white;
    }
...
<div class="container-fluid px-0">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            ...
            <p class="text-muted mb-0 mt-1">Update video resource information</p>
        </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header">
                    <h6 class="mb-0">
                        ...
                        Edit: {{ $resourceVideo->title }}
                    </h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.resource-videos.update', $resourceVideo->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('title', $resourceVideo->title) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" 
                                           ...
                                           value="{{ old('youtube_url', $resourceVideo->youtube_url) }}" 
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea name="description" 
                                              ...
                                              placeholder="Provide a brief description of the video content...">{{ old('description', $resourceVideo->description) }}</textarea>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category" 
                                        ...
                                        @php
                                            $categories = [
                                                'Scholarship Journey' => 'Scholarship Journey',
                                                'Scholarship Tips' => 'Scholarship Tips',
                                                'Scholarship Interview' => 'Scholarship Interview'
                                            ];
                                        @endphp
                                        @foreach($categories as $value => $label)
                                            <option value="{{ $value }}" 
                                                {{ old('category', $resourceVideo->category) == $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-0">
                                    ...
                                    <select name="is_active" class="form-select">
                                        <option value="1" {{ old('is_active', $resourceVideo->is_active) ? 'selected' : '' }}>
                                            🟢 Active - Visible to Students
                                        </option>
                                        <option value="0" {{ !old('is_active', $resourceVideo->is_active) ? 'selected' : '' }}>
                                            🔴 Inactive - Hidden
                                        </option>
                                    </select>
